...
public class AdditionTest {
  ...
  @Test
  public void print_NestedAdditions() {
    Addition a = new Addition(new NaturalNumber(3), new NaturalNumber(4));
    Addition b = new Addition(new NaturalNumber(88), a);

    String expectedOutput = "88+( 3+4 )";
    String output = b.toString();

    final String errorMsg = String.format("Problem printing products: %s", expectedOutput);
    assertThat(errorMsg, output, equalTo(expectedOutput));
  }
}
